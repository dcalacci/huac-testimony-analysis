...
all_speech_acts = {}
def populate_all_speech_acts():
    # iterate through all files, get speech acts for each
    # merge similar key names
    # 

def get_all_names():
    return [f.replace(".txt", "") for f in os.listdir(transcript_dir)]
